...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaternalMortalityReport.source'
        db.add_column('unfpa_core_maternalmortalityreport', 'source', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaternalMortalityReport.source'
        db.delete_column('unfpa_core_maternalmortalityreport', 'source')
