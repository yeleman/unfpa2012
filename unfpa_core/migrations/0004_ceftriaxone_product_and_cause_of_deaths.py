...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RHCommoditiesReport.ceftriaxone_500'
        db.add_column('unfpa_core_rhcommoditiesreport', 'ceftriaxone_500', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

        # Adding field 'RHCommoditiesReport.ceftriaxone_1000'
        db.add_column('unfpa_core_rhcommoditiesreport', 'ceftriaxone_1000', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

        # Adding field 'ChildrenMortalityReport.cause_of_death'
        db.add_column('unfpa_core_childrenmortalityreport', 'cause_of_death', self.gf('django.db.models.fields.CharField')(default='o', max_length=1), keep_default=False)

        # Adding field 'MaternalMortalityReport.cause_of_death'
        db.add_column('unfpa_core_maternalmortalityreport', 'cause_of_death', self.gf('django.db.models.fields.CharField')(default='o', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RHCommoditiesReport.ceftriaxone_500'
        db.delete_column('unfpa_core_rhcommoditiesreport', 'ceftriaxone_500')

        # Deleting field 'RHCommoditiesReport.ceftriaxone_1000'
        db.delete_column('unfpa_core_rhcommoditiesreport', 'ceftriaxone_1000')

        # Deleting field 'ChildrenMortalityReport.cause_of_death'
        db.delete_column('unfpa_core_childrenmortalityreport', 'cause_of_death')

        # Deleting field 'MaternalMortalityReport.cause_of_death'
        db.delete_column('unfpa_core_maternalmortalityreport', 'cause_of_death')
