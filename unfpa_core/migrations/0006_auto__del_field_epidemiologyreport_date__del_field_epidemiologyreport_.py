...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EpidemiologyReport.date'
        db.delete_column('unfpa_core_epidemiologyreport', 'date')

        # Deleting field 'EpidemiologyReport.reporting_location'
        db.delete_column('unfpa_core_epidemiologyreport', 'reporting_location_id')


    def backwards(self, orm):
        
        # Adding field 'EpidemiologyReport.date'
        db.add_column('unfpa_core_epidemiologyreport', 'date', self.gf('django.db.models.fields.DateField')(default=None), keep_default=False)

        # Adding field 'EpidemiologyReport.reporting_location'
        db.add_column('unfpa_core_epidemiologyreport', 'reporting_location', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.date(2012, 11, 21), related_name='epidemiology_reported_in', to=orm['bolibana.Entity']), keep_default=False)
