...
def serialize_maternalmortalityreport(report):
...
class Command(BaseCommand):
    help = ugettext_lazy("Export pnlp2011 MaternalMortalityReport to JSON")
    ...
    def handle(self, *args, **kwargs):
        ...
        for report in MaternalMortalityReport.objects.all():
            report_data = serialize_maternalmortalityreport(report)
        ...
        print("MaternalMortalityReport complete")
