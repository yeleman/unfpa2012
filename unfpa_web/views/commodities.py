...
from unfpa_core.exports import commodities_as_excel
...
@provider_permission('can_view_indicator_data')
def monthly_commodities_export(request, period):
...
@provider_permission('can_view_indicator_data')
def quarterly_commodities_export(request, period):
    return quarterly_annual_commodities_export(request, period, 'quarterly')


@provider_permission('can_view_indicator_data')
def annual_commodities_export(request, period):
    return quarterly_annual_commodities_export(request, period, 'annual')