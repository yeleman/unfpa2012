# Django settings for unfpa2012 project.
...
SECRET_KEY = '81jj!@(a#*o+6v5cqys_xv@n3v=ldjw!h=&-j&mz3%h&3qaa6z'
...
MIDDLEWARE_CLASSES = (
    # Gzip disabled so that http server can do it
